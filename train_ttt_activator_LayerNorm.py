...
from ttt_activator_LayerNorm import TTTM
...
class TTTImageClassification(TTTM):
    def __init__(
        self,
        image_size=32,
        patch_size=4,
...
model = TTTImageClassification().to(device)
print(model)
...
logname = "/PATH/TTT_Uniform_Activator_LayerNorm/Experiments_cifar10/logs_ttt/logs_cifar10.csv"
...
path = "/PATH/TTT_Uniform_Activator_LayerNorm/Experiments_cifar10/weights_ttt"
